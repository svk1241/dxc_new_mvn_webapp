...
public class BookDAO 
{
	public boolean insertBookDetails(Book b)
	{
		...
		try
		{
			 ...
			 pst.setNString(3, b.getAuthor()); pst.setString(4, b.getPublisher());
			 pst.setDouble(5,b.getPrice()); pst.setString(6, b.getSubject()); pst.setInt(7, b.getTotalCopies()); pst.setInt(8, b.getTotalCopies());
